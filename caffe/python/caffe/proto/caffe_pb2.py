...
_SALTPEPPERPARAMETER_SALTTYPE = _descriptor.EnumDescriptor(
  name='SaltType',
  full_name='caffe.SaltPepperParameter.SaltType',
  filename=None,
  file=DESCRIPTOR,
  values=[
    _descriptor.EnumValueDescriptor(
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='absolute', index=1, number=2,
      options=None,
      type=None),
  ],
  containing_type=None,
...
_DATAPARAMETER_DB = _descriptor.EnumDescriptor(
  ...
  values=[
    ...
    _descriptor.EnumValueDescriptor(
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='DATUMFILE', index=2, number=2,
      options=None,
      type=None),
  ],
  containing_type=None,
...
_V1LAYERPARAMETER_LAYERTYPE = _descriptor.EnumDescriptor(
  ...
  values=[
    ...
    _descriptor.EnumValueDescriptor(
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='PARSE_OUTPUT', index=28, number=41,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='PARSE_EVALUATE', index=29, number=42,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
...
_SOLVERPARAMETER = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='log_avg_gradient_norm', full_name='caffe.SolverParameter.log_avg_gradient_norm', index=26,
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='eval_type', full_name='caffe.SolverParameter.eval_type', index=37,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='test_before_snapshot', full_name='caffe.SolverParameter.test_before_snapshot', index=38,
...
_LAYERPARAMETER = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='norm_param', full_name='caffe.LayerParameter.norm_param', index=34,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='parse_evaluate_param', full_name='caffe.LayerParameter.parse_evaluate_param', index=35,
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='unpooling_param', full_name='caffe.LayerParameter.unpooling_param', index=47,
...
_TRANSFORMATIONPARAMETER = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='resize_param', full_name='caffe.TransformationParameter.resize_param', index=5,
      number=6, type=11, cpp_type=10, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='noise_param', full_name='caffe.TransformationParameter.noise_param', index=6,
      number=7, type=11, cpp_type=10, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='vertical_mirror', full_name='caffe.TransformationParameter.vertical_mirror', index=7,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='random_90_deg_rot', full_name='caffe.TransformationParameter.random_90_deg_rot', index=8,
...
_RESIZEPARAMETER = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='center_object', full_name='caffe.ResizeParameter.center_object', index=7,
      number=8, type=8, cpp_type=7, label=1,
      has_default_value=True, default_value=False,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='max_angle', full_name='caffe.ResizeParameter.max_angle', index=8,
      number=9, type=2, cpp_type=6, label=1,
      has_default_value=True, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_SALTPEPPERPARAMETER = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='type', full_name='caffe.SaltPepperParameter.type', index=0,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='fraction', full_name='caffe.SaltPepperParameter.fraction', index=1,
      number=1, type=2, cpp_type=6, label=1,
      has_default_value=True, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='value', full_name='caffe.SaltPepperParameter.value', index=2,
...
_BNPARAMETER = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='across_spatial', full_name='caffe.BNParameter.across_spatial', index=5,
...
_CONVOLUTIONPARAMETER = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='filter_stride', full_name='caffe.ConvolutionParameter.filter_stride', index=12,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='filter_stride_h', full_name='caffe.ConvolutionParameter.filter_stride_h', index=13,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='filter_stride_w', full_name='caffe.ConvolutionParameter.filter_stride_w', index=14,
...
_DATAPARAMETER = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='shuffle_buffer_size', full_name='caffe.DataParameter.shuffle_buffer_size', index=9,
      number=10, type=13, cpp_type=3, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_PARSEEVALUATEPARAMETER = _descriptor.Descriptor(
  name='ParseEvaluateParameter',
  full_name='caffe.ParseEvaluateParameter',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='num_labels', full_name='caffe.ParseEvaluateParameter.num_labels', index=0,
      number=1, type=5, cpp_type=1, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='ignore_label', full_name='caffe.ParseEvaluateParameter.ignore_label', index=1,
...
_POOLINGPARAMETER = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='bin_size', full_name='caffe.PoolingParameter.bin_size', index=10,
      number=13, type=13, cpp_type=3, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='bin_h', full_name='caffe.PoolingParameter.bin_h', index=11,
      number=14, type=13, cpp_type=3, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='bin_w', full_name='caffe.PoolingParameter.bin_w', index=12,
...
_SOFTMAXPARAMETER = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='neg_mult', full_name='caffe.SoftmaxParameter.neg_mult', index=4,
      number=5, type=2, cpp_type=6, label=1,
      has_default_value=True, default_value=1,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='neg_cid', full_name='caffe.SoftmaxParameter.neg_cid', index=5,
      number=6, type=5, cpp_type=1, label=1,
      has_default_value=True, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_LAYERPARAMETER.fields_by_name['parse_evaluate_param'].message_type = _PARSEEVALUATEPARAMETER
...
_SALTPEPPERPARAMETER.fields_by_name['type'].enum_type = _SALTPEPPERPARAMETER_SALTTYPE
_SALTPEPPERPARAMETER_SALTTYPE.containing_type = _SALTPEPPERPARAMETER;
...
DESCRIPTOR.message_types_by_name['ParseEvaluateParameter'] = _PARSEEVALUATEPARAMETER
...
class ParseEvaluateParameter(_message.Message):
  __metaclass__ = _reflection.GeneratedProtocolMessageType
  DESCRIPTOR = _PARSEEVALUATEPARAMETER
