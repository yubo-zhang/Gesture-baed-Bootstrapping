...
int main(int argc, char **argv){
    ...
    string image_fd = "../results/augmentation/RGBimages";
    string fd = image_fd+"/";

    string save_fd = "../results/augmentation/H5_files";
    mkdir(save_fd.c_str(), S_IRWXU | S_IRWXG | S_IROTH | S_IXOTH);
    string save = save_fd+"/";
    string gt_fd1  = "../results/augmentation/Masks";
    string gt_fd = gt_fd1+"/";

    string weight_fd1 = "../results/augmentation/Weights";
