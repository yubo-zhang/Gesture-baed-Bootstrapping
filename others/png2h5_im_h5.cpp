...
int main(int argc, char **argv){
	...
	// *******
	//This part is for images transformation used for detection
	//********

	char* video_name = argv[1];
    string video_name_str(video_name);
    string image_fd = "/home/yuboz/data/input_data/videos/det_test/"+video_name_str+"/RGBimages";
    string fd = image_fd+"/";

    string save_fd = "/home/yuboz/data/input_data/videos/det_test/"+video_name_str+"/H5_file";
